package org.multimedia.bookplayer.ui;
...
//		setBackgroundColor(Color.TRANSPARENT);  // 如果是在onDraw绘制Indicator,必须设置背景，否则onDraw不执行
		...
		mColor = ta.getColor(R.styleable.Indicator_custom_color, 0XFF00FF00);
		mHeight = (int) ta.getDimension(R.styleable.Indicator_custom_height, 2);
		ta.recycle();
